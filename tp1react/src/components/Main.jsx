    ...
    <div>
      ...
      <Card.Body>
        ...
        <Card.Text>
          ...
          Tengo {props.Alumno.Edad} años y tengo una mascota que se llama {props.Alumno.mascota[0].nombre} y es un {props.Alumno.mascota[0].especie} de {props.Alumno.mascota[0].edad} años.
        </Card.Text>
